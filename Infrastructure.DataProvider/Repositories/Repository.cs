...
namespace Infrastructure.DataProvider
{
		...
		where TSpecification : ISpecification<TDto>
	{
        ...
        public abstract IReadOnlyCollection<TDto> Get(IEnumerable<int> ids, TSpecification specification = default(TSpecification));
	    ...
	    /// <returns></returns>
	    public abstract IEnumerable<TDto> GetBySpecification(bool readOnly = true, TSpecification specification = default(TSpecification));
